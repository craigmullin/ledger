...
import { addServiceEntry, addVehicle, archiveVehicle, importServiceEntries, loadEntries, loadVehicles, updateVehicle, uploadEntryPhoto, uploadVehiclePhoto, type ImportedServiceEntryValues } from "./data";
...
export default function App() {
  ...
  const selectedVehicle = view.name === "vehicle" || view.name === "addEntry" || view.name === "editVehicle" || view.name === "importCsv"
